---
title: "Machine Learning no Mercado Financeiro"
...
A plataforma multimercado MetaTrader 5 permite executar transações no mercado Forex, de ações, futuros e contratos por diferença. Umas das funções mais importantes da MetaTrader 5 é o algotrading. Trata-se de uma negociação automatizada usando aplicativos especiais, especialmente, robôs de negociação. Eles agem sem a participação do trader, analisam de forma independente as cotações e executam transações de acordo com o algoritmo fixado neles.

A MetaTrader 5 dispõe de todo um ambiente de autodesenvolvimento, teste e otimização de robôs. O algorítimo é desenvolvido usando a linguagem MQL5.
...
Como visto na figura 2, o neuronio recebe os valores de entrada com seus respectivos pesos, que são trasformados pela função soma e fornece uma saida que é dada pela função de transferencia.
...
Observando a figura 3, pode-se concluir que a RNA possui o padão 3 X 6 X 1, ou seja, possui 3 neurônios na camada de entrada, 6 neuronios da camada oculta e 1 na camada de saida.
